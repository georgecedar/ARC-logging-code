...
// ============================================================
//  ROCKET SIMPLE LOGGER - CONFIGURATION
// ============================================================
...
// --- Launch Detection ---
#define LAUNCH_ACCEL_THRESHOLD  19.6f   // 2g in m/s2
...
// --- File Paths ---
#define MAX_FLIGHTS        99
#define FLIGHT_FMT         "/flight_%02d.bin"
#define PREFLIGHT_FMT      "/preflight_%02d.bin"
#define META_FMT           "/meta_%02d.txt"
